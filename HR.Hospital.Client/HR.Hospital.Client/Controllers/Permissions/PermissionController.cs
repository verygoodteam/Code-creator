...
namespace HR.Hospital.Client.Controllers.Permissions
{
    public class PermissionController : Controller
    {
        ...
        {
            var pagePermission = HttpClientApi.GetAsync<Common.List<PermissionDto>>("http://localhost:12345/api/Permission/GetPermmission?pageIndex=" + pageIndex + "&pageSize=" + pageSize);
