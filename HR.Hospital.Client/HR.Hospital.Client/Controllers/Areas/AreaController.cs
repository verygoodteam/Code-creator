...
namespace HR.Hospital.Client.Controllers.Areas
{
    public class AreaController : Controller
    {
        ...
        {
            var pageArea = HttpClientApi.GetAsync<Common.PageHelper<Area>>("http://localhost:12345/api/Areas/GetAreaList?pageIndex=" + pageIndex + "&pageSize=" + pageSize + "&areaProperty=" + areaProperty + "&areaName=" + areaName);
